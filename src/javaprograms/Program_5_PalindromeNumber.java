...
public class Program_5_PalindromeNumber {
    public static void main(String[] args) {
        ...
        boolean check = isPalindrome(a);  // check if number is palidrome or not
        if (check) {
        ...
        public static boolean isPalindrome ( int number){ // convert negative number to positive number
            if (number < 0) {
                number = -number;
            }
